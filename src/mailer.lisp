...
(defgeneric send (obj)
  ...
  (:method ((obj db:last-commit))
    (discord-send
     (format nil "repo: **~a**~%commit: ~a~%time: ~a~%link: ~a" (pretty-repo (db::last-commit-repo obj)) (db::last-commit-message obj) (db::last-commit-time obj) (db::last-commit-link obj))
